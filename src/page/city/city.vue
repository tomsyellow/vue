<template>
    <div class="city_container">
      ...
      <footer v-if="historytitle&&placelist.length" class="clear_all_history" @click="clearAll">清空所有记录</footer>
...
export default {
  data () {
    return {
      ...
      placelist: [], // 搜索城市列表
      placeHistory: [], // 历史搜索记录
      historytitle: true, // 迷人显示搜索历史头部,点击搜索后隐藏
  ...
  methods: {
    ...
    nextpage (index, geohash) {
      ...
      this.$route.push({path: '/msite', query: {geohash}})
    },
    clearAll () {
